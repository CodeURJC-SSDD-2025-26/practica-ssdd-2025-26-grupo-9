...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		userRepository.save(new User(1L, "user", passwordEncoder.encode("pass"), "algo@gmail.com", User.Role.USER));
		userRepository.save(new User(2L, "admin", passwordEncoder.encode("adminpass"), "admin@gmail.com", User.Role.ADMIN));
	}
